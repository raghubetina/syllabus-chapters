...
This course is very _project-driven_. We will, as much as possible, learn each skill by applying it to real-world examples of increasing complexity. We will then combine skills to build more and more functional applications.
